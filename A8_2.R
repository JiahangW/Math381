...
standing <- read.csv(
  "https://raw.githubusercontent.com/JiahangW/Math381/main/table1920.csv"
)
team_stats <- read.csv(
  "https://raw.githubusercontent.com/JiahangW/Math381/main/teams1920.csv"
)
all_data <- standing %>% 
